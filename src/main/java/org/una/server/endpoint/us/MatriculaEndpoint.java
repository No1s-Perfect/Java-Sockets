...
@ServerEndpoint(value = "/matricula", decoders = {JsonObjectDecoder.class}, encoders = {JsonObjectEncoder.class})
public class MatriculaEndpoint {
        
    private static final MatriculaController controller = MatriculaController.getInstance();
